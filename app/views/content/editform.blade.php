  ...
  <div class="mb-3">
    ...
    <div class="form-floating">
      ...
      <div class="mb-3">
        ...
        <input name="anh" style="height : 45px" value="{{$content->anh}}"class="form-control" type="file" id="formFileMultiple" multiple>
      </div>

      <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01">Người viết</label>
        <select name="ma_tai_khoan" value="{{$content->user()->ten_tai_khoan}}" class="form-select" id="inputGroupSelect01">
