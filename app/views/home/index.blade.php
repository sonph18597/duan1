      ...
      <div class="row">
        <div class="col-md-6">
          <div class="client_box">
            <div class="detail_box">
              <div class="img_box">
                <img src="{{PUBLIC_URL}}images/long.jpg" style="border-radius:50%;width:115px;height:115px">
              </div>
              <h5>
                Triều Trẻ Trâu
              </h5>
        ...
        <div class="col-md-6">
          <div class="client_box">
            <div class="detail_box">
              <div class="img_box">
                <img src="{{PUBLIC_URL}}images/trieu.jpg" style="border-radius:50%;width:115px;height:115px">
              </div>
              <h5>
                Long lồng lộn
              </h5>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="info_links pl-lg-5">
          <ul>
            <li class="active">
              <a href="{{BASE_URL.'trang-chu'}}">
                Trang chủ
              </a>
            </li>
            <li>
              <a href="{{BASE_URL.'kien-thuc'}}">
                Kiến Thức
              </a>
            </li>
            <li>
